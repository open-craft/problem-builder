...
from problem_builder.mixins import XBlockWithTranslationServiceMixin, StudentViewUserStateMixin, MakeURLAbsoluteMixin
...
class ChoiceBlock(
    ...
    def student_view_data(self, context=None):
        ...
        return {
            ...
            'display_name': self.make_url_absolute(self._(u"Choice ({content})").format(content=self.content)),
            'value': self.value,
            'content': self.make_url_absolute(self.content),
        }
