...
from problem_builder.mixins import XBlockWithTranslationServiceMixin, MakeURLAbsoluteMixin
...
@XBlock.needs("i18n")
class TipBlock(StudioEditableXBlockMixin, XBlockWithTranslationServiceMixin, XBlock, MakeURLAbsoluteMixin):
    """
